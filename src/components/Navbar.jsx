...
const NavbarComponent = () => {
  ...
  const navItems = [
    ...
    { to: '/hr-control', label: 'Upload Resume', icon: <Icon path="M3 6.75A2.25 2.25 0 015.25 4.5h13.5A2.25 2.25 0 0121 6.75v10.5A2.25 2.25 0 0118.75 19.5H5.25A2.25 2.25 0 013 17.25V6.75z" /> },
